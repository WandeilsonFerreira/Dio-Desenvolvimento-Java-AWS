...
public class VerificandoSenhas {
        ...
        public static String verificarForcaSenha(String senha) {
            ...
            if (tamanhoSenha < comprimentoMinimo) {
              String resultado = "Sua senha e muito curta. Recomenda-se no minimo 8 caracteres.";
              return resultado;
            } else if (temLetraMaiuscula && temLetraMinuscula && temNumero && temCaractereEspecial) {
              String resultado = "Sua senha atende aos requisitos de seguranca. Parabens!";
              return resultado;
            } else {
              String resultado = "Sua senha nao atende aos requisitos de seguranca.";
              return resultado;
            }
        }
    }